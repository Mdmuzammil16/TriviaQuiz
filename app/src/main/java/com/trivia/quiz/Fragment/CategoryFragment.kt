    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val list = arrayListOf<CategoryModel>(
            CategoryModel(
                ...
                "Geography",
                "Let's Explore more about our geographical Knowledge",
                R.drawable.geo,
                "geography"
            ), CategoryModel(
                "Music", "" + "Test Your Knowledge in Music", R.drawable.music, "music"
            ), CategoryModel(
                "Sports",
                ...
                "Food", "" + "Test Your Knowledge in Food", R.drawable.food, "food_and_drink"
            ), CategoryModel(
                "Flims", "" + "Test Your Knowledge in Flims", R.drawable.flim, "film_and_tv"
            )
